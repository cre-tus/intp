...
CREATE TABLE users (
    ...
    password_changed_at DATETIME(6) NULL COMMENT '비밀번호 변경 시각',
    terms_agreed_at DATETIME(6) NULL COMMENT '서비스 이용약관 확인 시각',
    privacy_notice_confirmed_at DATETIME(6) NULL COMMENT '개인정보 처리 안내 확인 시각',
    terms_version VARCHAR(30) NULL COMMENT '서비스 이용약관 버전',
    privacy_policy_version VARCHAR(30) NULL COMMENT '개인정보 처리방침 버전',
